...
public class ActiveAdapter extends RecyclerView.Adapter<ActiveAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ActiveAdapter.ViewHolder holder, int position) {
        ...
        Picasso.with(context).load("http://cookehome.com/CookApp/images/" + active_list.get(position).getOrder_img()).into(holder.item_image);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            item_Quantity = (TextView) itemView.findViewById(R.id.order_item_quantity);
            item_total_price = (TextView) itemView.findViewById(R.id.order_item_totalprice);
            item_state = (TextView) itemView.findViewById(R.id.order_state);
            item_image = (ImageView) itemView.findViewById(R.id.order_item_img);
